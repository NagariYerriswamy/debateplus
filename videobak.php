  ...
  <div class="st-container">
    ...
    <div class="sidebar left sidebar-size-2 sidebar-offset-0 sidebar-visible-desktop sidebar-visible-mobile sidebar-skin-dark" id="sidebar-menu" data-type="collapse">
     <!--  <div data-scrollable> -->
      ...
      <li><a href="../../../index.php"><i class="icon-paint-brush"></i> <span><?php echo $catRow['cat_name'];?></span></a></li>
        <?php while($catRow=mysqli_fetch_assoc($selResult)):?>
          <?php $allCat[]=$catRow['cat_name']; ?>    
     <li><a href="video.php?v=<?php echo $catRow['cat_name']?>"><i class="icon-paint-brush"></i> <span><?php echo $catRow['cat_name'];?></span></a></li>
        <?php endwhile;?>
    <?php //var_dump($allCat);?>
    <?php //var_dump($allCat);?>
          <!--<li class=""><a href="#"><i class="icon-user-1"></i> <span>Latest</span></a></li>
          <li class=""><a href="#"><i class="fa fa-group"></i> <span>Trending</span></a></li>
          <li class=""><a href="#"><i class="icon-comment-fill-1"></i> <span>Most Viewed</span></a></li>
          <li><a href="login.html"><i class="icon-lock-fill"></i> <span>New Uploads</span></a></li>
      <li class=""><a href="#"><i class="icon-user-1"></i> <span>Latest</span></a></li>
          <li class=""><a href="#"><i class="fa fa-group"></i> <span>Trending</span></a></li>
          <li class=""><a href="#"><i class="icon-comment-fill-1"></i> <span>Most Viewed</span></a></li>
          <li><a href="login.html"><i class="icon-lock-fill"></i> <span>New Uploads</span></a></li>
